...
public class HListViewEditor : Editor {

    [MenuItem("GameObject/UI/HListView")]
    static void CreateBloodSlider()
    {
        ...
        GameObject bloodSlider = Instantiate(Resources.Load("Widget/HListView") as GameObject);
        bloodSlider.name = "HListView";
