...
namespace RT
{
    ...
    /// 幸运玩家列表
    /// </summary>
    public class LuckyPlayerView : HideMonoBehaviour, ITableViewDataSource, ITableViewDelegate
    {
        ...
        public GameObject itemLuckyPrefab;
        ...
        private void Start()
        {
            ...
            tableView.RegisterPrefabForCellReuseIdentifier(itemLuckyPrefab, "ItemLuckyCRI");
            findList(true);
        }
        ...
        {
            ItemLuckyCell cell = tableView.ReusableCellForRow("ItemLuckyCRI", row) as ItemLuckyCell;
            cell.name = "cell_" + row;
            cell.data = _md[row];
